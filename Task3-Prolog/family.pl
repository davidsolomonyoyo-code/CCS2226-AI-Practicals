...
/* ─────────────────────────────────────────────
   QUERIES TO RUN - COPY ONE BY ONE:

   ?- consult('C:/Users/Admin/family.pl').

   Grandparents of peter:
   ?- grandparent(X, peter).
   Expected: henry, susan, john, rose

   Grandchildren of george:
   ?- grandchild(X, george).
   Expected: tom, grace, helen

   Cousins of peter (no duplicates):
   ?- cousins_of(peter, X).
   Expected: [kevin]
   ...
   Press ; after each answer to see more.
   ───────────────────────────────────────────── */
